...
- [Executaveis](#executaveis)
  - [Criar ambiente virtual](#1-criar-ambiente-virtual)
  - [Instalar dependências](#2-instalar-dependencias)
  - [Aplicar migrações](#3-aplicar-migrações-caso-necessário)
  - [Rodar o servidor local](#4-rodar-o-servidor-local)
  - [Executar os testes automatizados](#5-executar-os-testes-automatizados)
